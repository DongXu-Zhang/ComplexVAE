...
from microscopy_vae.metrics.aggregation import group_bootstrap_ci, page_to_group_macro
from microscopy_vae.metrics.fidelity import mae, psnr, signed_mean_bias
...
def evaluate_hq_loader(
    ...
    *,
    ...
    keys = ["mae", "psnr", "signed_bias", "abs_bias", "kl_mean"]
    ...
    if report_constant_baseline and const_page:
        out["constant_baseline"] = {
            "group_macro": page_to_group_macro(const_page, group_ids, keys),
